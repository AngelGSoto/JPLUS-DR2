...
% \centering
% \begin{tabular}{l l}
%  \includegraphics[width=0.5\linewidth, trim=10 10 10 10, clip]{../../SJ-PLUS/Plots-splus/Fig1-SPLUS18-PC1-PC2-orig.pdf} & \includegraphics[width=0.5\linewidth, trim=10 10 10 10, clip]{../../../../../../home/angel/dropbox/JPAS/Plots-splus/Fig1-SPLUS18-PC1-PC2_SMOTE.jpg} \\
% %\raiselabel{(\textit{a})} & \raiselabel{(\textit{b})}\\
% \includegraphics[width=0.5\linewidth, trim=10 10 10 10, clip]{../../SJ-PLUS/JPAS/Plots-splus/Fig2-JPLUS18-PC1-PC3.jpg} & \includegraphics[width=0.5\linewidth, trim=10 10 10 10, clip]{../../SJ-PLUS/JPAS/Plots-splus/Fig2-JPLUS18-PC1-PC3_SMOTE.jpg} \\
...
% \clearpage
% \begin{longtable}{ccc}
%   \input{table-images-pnknown.tex}
% \end{longtable}
