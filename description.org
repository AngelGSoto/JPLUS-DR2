...
I ran again PCA with IAG machine, I found very diferent results I have to check that.
...
**** JPLUS images
  ...
  + To write the REGIOn files there is to use:
  ...
  + I have to continue dolownd the images. The last one ~Field_6863~. Done.
